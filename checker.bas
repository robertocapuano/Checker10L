...
71 S=SGN(RND(1)-.5):forJ=0to7:U=(J+DU)mod8:forI=0to7:Q=(CK(U,V)and4):V=(I+DV)mod8:forK=-StoS step S*2:forL=-1to(-(Q=4))step2: if (L=-1 and U=0) or (L=1andU=7) or (CK(U,V)and2)<>2 then75
