...
63 IF U>1 and CK(U,V)=2 then if CK(U-1,V+D)=1 and CK(U-2,V+2*D)=0 then CK(U,V)=0: CK(U-1,V+D)=0:CK(U-2,V+2*D)=2 : I=7:J=7: AI=1: vpokeB-120+P2,p(1): P2=P2+1
65 next I,J

70 if P2=12 then 10 else if AI=1 then 40
