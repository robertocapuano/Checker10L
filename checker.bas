...
20 CE=CK((R+R0)/2, (C+C0)/2 ):if (Q=0 and R<>R0+2) or abs(R-R0)<>2 or abs(C0-C)<>2 or CK(R,C)<>0 or (CE and 2)<>2 or Q<(CEand4) then C=C0: R=R0: goto 10:else:CK(R-1,(C+C0)/2 )=0:CK(R,C)=CK(R0,C0):CK(R0,C0)=0:P1=P1+1:vpokeB+479+P1,p(CE):beep
