...
20 if R<>R0+2 or abs(C0-C)<>2 or CK(R,C)<>0 or CK(R-1, (C+C0)/2 )<>2 then C=C0: R=R0: goto 10:else:CK(R-1,(C+C0)/2 )=0:CK(R,C)=1:CK(R0,C0)=0:P1=P1+1:vpokeB+479+P1,p(2):beep::if P1=12 then locate0,0:?"USER WINS":k$=INPUT$(1): goto 1
