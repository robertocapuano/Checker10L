...
44 CK(R-1,(C+C0)/2 )=0:CK(R,C)=1:CK(R0,C0)=0:P1=P1+1:vpokeB+479+P1,p(2):beep:gosub200:if P1=12 then 20: else 60


rem ai
60 AI=0:DU=RND(1)*7:DV=RND(1)*7:forJ=0to7:U=(J+DU)mod8:forI=0to7:V=(I+DV)mod8:forK=-1to1step2:D=-(V<2)++(V>5)+(V>1)*(V<6)*K
